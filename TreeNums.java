...
public class TreeNums {
  public List<Integer> searcher(int h, List<Integer> integerList) {
  ...
  public List<Integer> matchExists (List<Integer> integerList, int parentIndex, int childIndex, List<Integer> answerList) {
    for(int i = 0; i < integerList.size(); i++) {
  ...
  public List<Integer> helpSearcher(int headIndex, int h, List<Integer> integerList, List<Integer> answerList) {
    if(h > 1) {
      int hminus1 = (int) Math.pow(2.0,h-1);
      int leftChildIndex = headIndex - hminus1;
      int rightChildIndex = headIndex-1;
